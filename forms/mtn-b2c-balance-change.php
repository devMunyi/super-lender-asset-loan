...
$current_bal = fetchrow('o_summaries', "uid=4", "value_");
/////---------End of session check

?>
<form class="form-horizontal" id="doc-upload" method="POST" action="action/system/mtn-b2c-balance-change" enctype="multipart/form-data">
    <div class="box-body">
        <div class="form-group">
            <label for="name" class="col-sm-3 control-label">MTN B2C Balance</label>
