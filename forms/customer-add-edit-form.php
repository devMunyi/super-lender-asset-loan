<section class="content-header">
    <h1>
        ...
        <?php
        $cid = intval($_GET['customer-add-edit']);
        ...
        if ($cid > 0) {
            ...
            $cust['status'] = 3;
            if ($default_limit > 0) {
                $cust['loan_limit'] = $default_limit;
            }
            if ($default_product > 0) {
                $cust['primary_product'] = $default_product;
            }
        }
        ?>
                ...
                <div class="row">
                    <div class="col-sm-2">
                        ...
                        if ($edit > 0) {
                            ...
                            if ($update_addon != 1) {
                                exit(errormes("You don't have permission to edit customer"));
                            }
                            ...
                            <ul class="list-group">
                                ...
                                if ($display_guarantors_tab == 1) {
                                    ?>
                                    <li class="list-group-item"><a
                                            href="customers?customer-add-edit=<?php echo $customer_id; ?>&guarantors"
                                            aria-expanded="false"><i class="fa fa-users"></i> Guarantors</a></li>
                                <?php }
                                ?>
                                <li class="list-group-item"><a
                                        href="customers?customer-add-edit=<?php echo $customer_id; ?>&referees"
                                        aria-expanded="false"><i class="fa fa-users"></i> Referees</a></li>
                                <li class="list-group-item"><a
                                        href="customers?customer-add-edit=<?php echo $customer_id; ?>&collateral"
                                        aria-expanded="false"><i class="fa fa-tag"></i> Collateral</a></li>
                                <li class="list-group-item"><a
                                        href="customers?customer-add-edit=<?php echo $customer_id; ?>&uploads"
                                        aria-expanded="false"><i class="fa fa-cloud-upload"></i> Uploads</a></li>
                                <li class="list-group-item"><a
                                        href="customers?customer-add-edit=<?php echo $customer_id; ?>&other"
                                        aria-expanded="false"><i class="fa fa-info-circle"></i> Other</a></li>
                            ...
                            if ($update_addon != 1) {
                                exit(errormes("You don't have permission to add customer"));
                            }
                        }
                        ?>
                    </div>
                    <div class="col-sm-6">
                        ...
                        if (isset($_GET['contact'])) {
                            ...
                            <a class="btn-outline-black pull-right"
                                href="customers?customer-add-edit=<?php echo $cid; ?>&<?php echo $display_guarantors_tab == 1 ? 'guarantors' : 'referees'; ?>">Next
                                <i class="fa fa-angle-double-right"></i></a><a
                                href="customers?customer-add-edit=<?php echo $cid; ?>&contact"
                                class="btn-outline-black pull-right">New <i class="fa fa-plus"></i></a>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control"
                                                id="contact_value"><?php echo $value; ?></textarea>
                                        </div>
                                    </div>
                            ...
                            <?php
                        } elseif (isset($_GET['guarantors'])) {

                            $guarantor_id = $_GET['guarantors'];
                            if ($guarantor_id > 0) {
                                $l = fetchonerow("o_customer_guarantors", "uid=" . decurl($guarantor_id), "*");
                                $relationship = $l['relationship'];
                                echo " <h3>Edit Guarantor";
                            } else {
                                echo " <h3>New Guarantor";
                            }
                            ?>
                            <a class="btn-outline-black pull-right"
                                href="customers?customer-add-edit=<?php echo $cid; ?>&referees">Next <i
                                    class="fa fa-angle-double-right"></i></a>
                            <a class="btn-outline-black pull-right"
                                href="customers?customer-add-edit=<?php echo $cid; ?>&contact">Back <i
                                    class="fa fa-angle-double-left"></i></a>
                            <a href="customers?customer-add-edit=<?php echo $cid; ?>&referees"
                                class="btn-outline-black pull-right">New <i class="fa fa-plus"></i></a></h3>
                            <form class="form-horizontal" id="guarantor_form" onsubmit="return false;" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        <input type="hidden" id="guarantor_id" value="<?php echo $guarantor_id; ?>">
                                        <label for="guarantor_name" class="col-sm-3 control-label">Full Name</label>

                                        <div class="col-sm-9">
                                            <input type="text" class="form-control"
                                                value="<?php echo $l['guarantor_name'] ?>" id="guarantor_name"
                                                placeholder="First Middle Last">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="g_national_id" class="col-sm-3 control-label">National ID</label>

                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="g_national_id"
                                                value="<?php echo $l['national_id']; ?>" placeholder="8 Characters">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="g_mobile_no" class="col-sm-3 control-label">Phone Number</label>

                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="g_mobile_no"
                                                value="<?php echo $l['mobile_no']; ?>" placeholder="07...">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="g_physical_address" class="col-sm-3 control-label">Home Address</label>
                                        <div class="col-sm-9">
                                            <textarea class="form-control" id="g_physical_address"
                                                placeholder=""><?php echo $l['physical_address']; ?></textarea>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="amount_guaranteed" class="col-sm-3 control-label">Amount
                                            Guaranteed</label>

                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="amount_guaranteed"
                                                value="<?php echo $l['amount_guaranteed']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" id="g_relationship">
                                                <option value="0">--Select One</option>
                                                <?php

                                                $recs = fetchtable('o_customer_guarantor_relationships', "status=1", "name", "ASC", "100", "uid ,name");
                                    ...
                                    <div class="col-sm-9">
                                        <div class="box-footer">
                                            ...
                                            <button type="submit"
                                                ...
                                                onclick="customer_add_guarantor('<?php echo $cid; ?>');">Save
                                            </button>
                                        </div>
                                    </div>
                            ...
                            ?>
                            <a class="btn-outline-black pull-right"
                                href="customers?customer-add-edit=<?php echo $cid; ?>&collateral">Next <i
                                    class="fa fa-angle-double-right"></i></a>
                            <a class="btn-outline-black pull-right"
                                href="customers?customer-add-edit=<?php echo $cid; ?>&<?php echo $display_guarantors_tab == 1 ? 'contact' : 'contact'; ?>">Back
                            ...
                            <form class="form-horizontal" id="ref_form" onsubmit="return false;" method="post">
                                <div class="box-body">
                                    ...
                                    <div class="form-group" style="display: none;">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" value="<?php echo $l['email_address']; ?>"
                                                class="form-control" autocomplete="OFF" id="email_"
                                    ...
                                    <div class="form-group" style="display: none;">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="national_id"
                                                value="<?php echo $l['id_no']; ?>" placeholder="8 Characters">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" id="main_address"
                                                placeholder=""><?php echo $l['physical_address']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            ?>
                                ...
                                <a class="btn-outline-black pull-right"
                                    href="customers?customer-add-edit=<?php echo $cid; ?>&uploads">Next <i
                                        class="fa fa-angle-double-right"></i></a>
                                <a class="btn-outline-black pull-right"
                                    href="customers?customer-add-edit=<?php echo $cid; ?>&referees">Back <i
                                        class="fa fa-angle-double-left"></i></a>
                                <a href="customers?customer-add-edit=<?php echo $cid; ?>&collateral"
                                    class="btn-outline-black pull-right">New <i class="fa fa-plus"></i></a>
                                ...
                                <form class="form-horizontal" onsubmit="return false;" method="post">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control" id="money_value"
                                                    value="<?php echo $c['money_value'] ?>" placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-group" style="display: none;">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control"
                                                    value="<?php echo $c['doc_reference_no'] ?>" id="reference_number">
                                            </div>
                                        </div>
                                        <div class="form-group" style="display: none;">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control"
                                                    value="<?php echo $c['filling_reference_no'] ?>"
                                                    id="physical_file_number" />
                                            </div>
                                        </div>
                                        <div class="form-group" style="display: none;">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control"
                                                    value="<?php echo $c['document_scan_address']; ?>" id="digital_file_number">
                                            </div>
                                        </div>
                            ...
                            ?>
                                ...
                                ?>
                                    <a class="btn-outline-black pull-right"
                                        href="customers?customer=<?php echo $cid; ?>&uploads">Finish <i
                                            class="fa fa-check-circle"></i></a>
                                    <a class="btn-outline-black pull-right"
                                        href="customers?customer-add-edit=<?php echo $cid; ?>&uploads">Back <i
                                            class="fa fa-angle-double-left"></i></a>
                                    </h3>
                                    <form class="form-horizontal no-right-click" id="other_frm" onsubmit="return false;" method="post">
                                        <div class="box-body">
                                        ...
                                        $forms = fetchtable('o_forms', "status=1 $and_form", "uid", "asc", "100");
                                        while ($f = mysqli_fetch_array($forms)) {
                                            ...
                                            while ($o = mysqli_fetch_array($otherf)) {
                                                ...
                                                if ($field_type == 'SELECT') {
                                                ...
                                                } elseif (trim($field_type) == 'NUMBER') {
                                                    $in = "<input class='form-control' $condition_ value='$current_saved_value' placeholder='$caption_' id=\"in_$field_id\" type=\"$field_type\">";
                                                    ...
                                                    $in = "<input class='form-control'
                                                placeholder='$caption_' $condition_ value='$current_saved_value' id=\"in_$field_id\" type=\"$field_type\">";
                                                }
                                                $field_options = $o['field_options'];
                        ...
                        <div class=\"col-sm-9\">
                                        ...
                                        if ($total_fields > 0) {
                                            ?>
                                                <textarea style="display: none;"
                                                    id="other_fields"><?php echo implode(',', $fields); ?></textarea>
                                                <div class="col-sm-3"></div>
                                                <div class="col-sm-9">
                                                    <div class="box-footer">
                                                        <br />
                            ...
                            ?>
                                        <h3>Upload File <a class="btn-outline-black pull-right"
                                                href="customers?customer-add-edit=<?php echo $cid; ?>&other">Next <i
                                                    class="fa fa-angle-double-right"></i></a>
                                            <a class="btn-outline-black pull-right"
                                                href="customers?customer-add-edit=<?php echo $cid; ?>&collateral">Back <i
                                                    class="fa fa-angle-double-left"></i></a>
                                            <a href="customers?customer-add-edit=<?php echo $cid; ?>&uploads"
                                                class="btn-outline-black pull-right">New <i class="fa fa-plus"></i></a>
                                        </h3>
                                        <form class="form-horizontal" id="doc-upload" method="POST"
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-control" name="type_" id="type_">
                                                            <option value="0">--Select One</option>
                                                    <?php
                                                    $o_customer_document_categories_ = fetchtable('o_customer_document_categories', "uid>0", "uid", "desc", "0,100", "uid ,name ");
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <label> <input type="checkbox" value="1" CHECKED id="make_thumbnail"
                                                                name="make_thumbnail"> Yes</label>
                                                    </div>
                                                </div>
                                                ...
                                                if ($upload_external == 1) {
                                                    ?>
                                                            <button id="submit-btn" type="submit" class="btn btn-success btn-lg pull-right"
                                                                onclick="customerFileUpload();">Submit
                                                            </button>
                                                <?php
                                                } else {
                                                    ?>
                                                            <button id="submitBtn" type="submit" class="btn btn-success btn-lg pull-right"
                                                                onclick="formready('doc-upload');">
                            ...
                            if ($geo_location_enforced == 1) {
                                ?>
                                            <div id="locationbox" class="bg-yellow-gradient  alert" style="display: none;">
                                                <span class="font-16 font-bold text-black" id="locationStatus">Checking location
                                                    services...</span>
                                                <button id="enableButton" class="btn-primary pull-right" onclick="showInstructions()"><i
                                                        class="fa fa-map-marker"></i> Enable</button>
                                            </div>
                                <?php
                            }
                            ...
                            ?>
                                        ...
                                        <form class="form-horizontal" id="bio_form" onsubmit="return false;" method="post">
                                            <div class="box-body">
                                                <div class="form-group">
                                                ...
                                                <div class="form-group"
                                                 style="display: <?php echo $email_disabled == 1 && !$cid > 0 ? "none" : ""; ?>"
                                                >
                                                    <label for="email_" class="col-sm-3 control-label">Email</label>

                                                    <div class="col-sm-9">
                                                        <input type="email" class="form-control"
                                                            value="<?php echo $cust['email_address']; ?>" autocomplete="OFF" id="email_"
                                                            placeholder="user@email.com">
                                                    </div>
                                                </div>
                                                <div class="form-group"
                                                    style="display: <?php echo $national_id_disabled == 1 && !$cid > 0 ? "none" : ""; ?>">
                                                    <label for="national_id" class="col-sm-3 control-label">National ID</label>

                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control"
                                                            value="<?php echo $cust['national_id']; ?>" id="national_id"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control"
                                                            value="<?php echo $cust['primary_mobile']; ?>" id="phone_number"
                                                            placeholder="07...">
                                                    </div>
                                                </div>

                                                <div class="form-group" style="display: <?php echo $cc === 256 ? 'block' : 'none'; ?>;">
                                                    <label for="phone_number_provider" class="col-sm-3 control-label">Phone Number
                                                        Provider</label>
                                                    ...
                                                    while ($e = mysqli_fetch_array($o_telecomms_)) {
                                                        ...
                                                        if ($cc == 254) {
                                                            $cust['phone_number_provider'] = 1; // assign safaricom as default
                                                        }
                                                ...
                                                <div class="form-group"
                                                    style="display: <?php echo $dob_disabled == 1 && !$cid > 0 ? "none" : ""; ?>">
                                                    <label for="dob" class="col-sm-3 control-label">DOB</label>

                                                    <div class="col-sm-9">
                                                        <input type="date" value="<?php echo $cust['dob']; ?>" class="form-control"
                                                            id="dob">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <label><input type="radio" <?php echo $male_checked; ?> name="gender" value="M">
                                                            Male</label>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label><input type="radio" <?php echo $female_checked; ?> name="gender"
                                                ...
                                                <div class="form-group">
                                                    <label for="main_address"
                                                        class="col-sm-3 control-label"><?php echo $switch_home_with_business_address == 1 ? "Business Address" : "Home Address" ?></label>

                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" id="main_address"
                                                            placeholder="123 Street"><?php echo $cust['physical_address']; ?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group" style="display: <?php echo $geo_textarea_display; ?>;">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" id="initial_geolocation"
                                                            style="display: none;"><?php echo $cust['geolocation']; ?></textarea><br />
                                                        <textarea class="form-control" id="geolocation"
                                                            style="display: <?php echo $geo_textarea_display; ?>;"><?php echo $cust['geolocation']; ?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control"
                                                            value="<?php echo $cust['loan_limit']; ?>" id="loan_limit" placeholder="0">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    while ($u = mysqli_fetch_array($o_branches_)) {
                                                        $uid = $u['uid'];
                                                        $name = $u['name'];
                                                        if (($cust['branch']) == $uid || $user_branch == $uid) {
                                                ...
                                                <div class="form-group" style="display: none;">
                                                    ...
                                                    $o_staff = fetchtable('o_users', "status=1 AND branch > 1", "name", "asc", "0,10000", "uid ,name");
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="box-footer">
                                                        <br />
                                                        <button type="submit" class="btn btn-lg btn-default">Cancel</button>
                                                        <button id="customer-add-edit" type="submit"
                                                            class="btn btn-success btn-lg pull-right" onclick="customer_save();">Save
                                                        </button>
                                                    </div>
                                                </div>
                    ...
                    <div class="col-sm-4 box-body">
                        ...
                        if (isset($_GET['guarantors'])) {
                            $guarantor_list = $_GET['customer-add-edit'];
                            ?>
                            <div class="small_list" id="guarantors_">
                                Loading ...
                            </div>
