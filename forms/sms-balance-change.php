...
$current_bal = fetchrow('o_summaries', "uid=3", "value_");
/////---------End of session check

?>
            <form class="form-horizontal" id="doc-upload" method="POST" action="action/system/sms-balance-change" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="form-group">
                        <label for="name" class="col-sm-3 control-label">SMS Balance</label>
