...
$current_bal = fetchrow('o_summaries', "uid=1", "value_");
/////---------End of session check

?>
            <form class="form-horizontal" id="doc-upload" method="POST" action="action/system/b2c-balance-change" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="form-group">
                        <label for="name" class="col-sm-3 control-label">B2C Balance</label>
