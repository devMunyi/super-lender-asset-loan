...
?>
<br/>
<div class="box-separator text-red">
    <i class="fa fa-chain-broken"></i>  DEFAULTERS (By Due Dates)
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="box   box-solid">
                    <div class="box-header box-title bg-red font-bold">




                        <div class="pull-left">  &nbsp;&nbsp; &nbsp;&nbsp;
                            <button onclick="input_add('#defobj', 'BRANCH'); nd_default_list();" class="btn btn-default font-bold bg-red-gradient">Per Branch</button>
                            <button onclick="input_add('#defobj', 'PRODUCT'); nd_default_list();" class="btn btn-default font-bold bg-red-gradient">Per Product</button>
                            <button onclick="input_add('#defobj', 'AGENT'); nd_default_list();" class="btn btn-default font-bold bg-red-gradient">Per Agent</button>
                            <button onclick="input_add('#defobj', 'GROUP'); nd_default_list();" class="btn btn-default font-bold bg-red-gradient">Per Group</button>
                            <button onclick="input_add('#defobj', 'MONTHLY'); nd_default_list();" class="btn btn-default font-bold bg-red-gradient">Per Month</button>
                            <button onclick="input_add('#defobj', 'WEEKLY'); nd_default_list();" class="btn btn-default font-bold bg-red-gradient">Per Week</button>
                            <button onclick="input_add('#defobj', 'DAILY'); nd_default_list();" class="btn btn-default font-bold bg-red-gradient">Per Day</button>
                            <input type="hidden" id="defobj" value="DAILY">

                        </div>
                        <div class="pull-right">
                            <input type="date" value="<?php echo $start_date; ?>" id="start_date_default" class="btn btn-default text-gray font-bold">
                            <input type="date" value="<?php echo $end_date; ?>" id="end_date_default" class="btn btn-default text-gray font-bold">
                            <button onclick="nd_default_list();" class="btn btn-success bg-black-gradient font-bold">GO</button>
                        </div>


                    </div>
                    <!-- /.box-header -->
                    <div class="box-body scroll-hor" style="background: white;" id="nd_default_loans">
                        <a onclick="nd_default_list();" href="javascript:void(0)" class="font-bold text-blue hotbutton"><i class="fa fa-refresh"></i> Click to View</a>
