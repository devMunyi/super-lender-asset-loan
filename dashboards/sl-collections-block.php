...
<div class="box-separator">
    <i class="fa fa-download"></i>  COLLECTIONS
            ...
            <div class="col-sm-12">
                <div class="box bg-purple box-solid">
                    <div class="box-header box-title">
                        ...
                        <div class="pull-left">
                            <button onclick="input_add('#dobjp', 'BRANCH'); nd_pay_list();" class="btn btn-default bg-purple-gradient font-bold">Per Branch</button>
                            <button onclick="input_add('#dobjp', 'PRODUCT'); nd_pay_list();" class="btn btn-default bg-purple-gradient font-bold">Per Product</button>
                            <button onclick="input_add('#dobjp', 'AGENT'); nd_pay_list();" class="btn btn-default bg-purple-gradient font-bold">Per Agent</button>
                            <button onclick="input_add('#dobjp', 'GROUP'); nd_pay_list();" class="btn btn-default bg-purple-gradient font-bold">Per Group</button>
                            <button onclick="input_add('#dobjp', 'MONTHLY'); nd_pay_list();" class="btn btn-default bg-purple-gradient font-bold">Per Month</button>
                            <button onclick="input_add('#dobjp', 'WEEKLY'); nd_pay_list();" class="btn btn-default bg-purple-gradient font-bold">Per Week</button>
                            <button onclick="input_add('#dobjp', 'DAILY'); nd_pay_list();" class="btn btn-default bg-purple-gradient font-bold">Per Day</button>
                            <input type="hidden" id="dobjp" value="DAILY">

                        </div>
                        <div class="pull-right"><a class="fa fa-info-circle text-light-blue" title="Due date"></a>
                            <input type="date" value="<?php echo $start_date; ?>" id="start_date_pay" class="btn btn-default font-bold" style="color: white;">
                            <input type="date" value="<?php echo $end_date; ?>" id="end_date_pay" style="color: white;" class="btn btn-default font-bold">
                            <button onclick="nd_pay_list();" class="btn btn-success font-bold bg-black-gradient">GO</button>
                        </div>


                    </div>
                    <!-- /.box-header -->
                    <div class="box-body scroll-hor text-black" style="background: white;" id="nd_dashboard_payments">
                        <a onclick="nd_pay_list();" href="javascript:void(0)" class="font-bold text-blue hotbutton"><i class="fa fa-refresh"></i> Click to View</a>
