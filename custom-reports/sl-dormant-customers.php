...
$branchs = table_to_obj('o_branches', "uid > 0", "10000", "uid", "name");
...
$customers = fetchtable('o_customers', "uid IN ($customer_list) AND uid not in ($customers_with_loans_list) AND loan_limit > 0 $andExemptHQ", "uid", "ASC", 10000000, "uid, full_name, primary_mobile, national_id, gender, loan_limit, added_date, branch");
