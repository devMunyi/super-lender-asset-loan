        ...
        <div class="col-sm-12">
            <table id="example2" class="table table-condensed table-striped table-bordered">
                ...
                <tr><th>ID</th><th>BDO</th><th>Branch</th><th>New Leads</th> <th>New Customers</th><th>New Total Loans</th> <th>Repeat Customers</th><th>Repeat Total Loans</th><th>Active Customers</th><th>All Total Loans</th></tr>
                  ...
                  $bdos = fetchtable('o_users',"user_group IN (7, 8) $andbranch_client AND uid > 0","branch","asc","10000","uid, name, branch, status, user_group");
                  ...
                  while($b = mysqli_fetch_array($bdos)){
                        ...
                        $user_status = intval($b['status']);
                        $user_group = intval($b['user_group']);
                      ...
                      if($new_leads  == 0 && $new_loans == 0 && $new_loans_sum == 0 && $repeat_loans == 0 && $repeat_loans_sum == 0 && $active_customers == 0 && ($user_status != 1 || $co_name == "")){
                          continue;
                      }

                      if(!isset($bdo_uids_tracker[$bid]) && !isset($pair_tracker[$bid])){
