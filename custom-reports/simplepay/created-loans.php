    ...
    <table id="example2" class="table table-condensed table-striped table-bordered">
        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                echo "<tr><td>$uid</td><td>$full_name</td><td>$branch</td><td>$phone</td><td>$loan_amount</td><td>$interest</td><td>$amount_repayable</td><td>$amount_repaid</td><td>$balance</td><td>$LO</td><td>$CO</td><td>$application_mode</td><td>$created_at</td><td>$status</td></tr>";
