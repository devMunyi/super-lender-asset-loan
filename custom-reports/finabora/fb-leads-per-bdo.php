...
$bdo_leads = array();
$leads = fetchtable('o_customers',"status in (1,3)  AND date(added_date) >= '$start_date' AND date(added_date) <= '$end_date'","uid","asc","1000000","uid, branch, added_date, added_by");
...
$bdo_balance = array();
$bdo_repayable = array();
$loans = fetchtable('o_loans',"given_date >= '$start_date' AND given_date <= '$end_date'  AND disbursed=1 AND status!=0","uid","asc","1000000","uid, current_branch, current_lo,customer_id, loan_amount, total_repaid, loan_balance, total_repayable_amount");
        ...
        <div class="col-sm-12">
            <table id="example2" class="table table-condensed table-striped table-bordered">
                ...
                <tr><th>ID</th><th>BDO</th><th>Branch</th><th>New Leads</th> <th>New Customers</th><th>New Total Loans</th> <th>Repeat Customers</th><th>Repeat Total Loans</th><th>All Total Loans</th><th>Total Repayable</th><th>Paid</th><th>Balance</th><th>Rate</th></tr>
                  ...
                  $bdos = fetchtable('o_users',"user_group = 7  AND status=1","uid","asc","1000","uid, name, branch");
                  while($b = mysqli_fetch_array($bdos)){
                      ...
                      $lo_balance = false_zero($loan_balance[$bid]);
