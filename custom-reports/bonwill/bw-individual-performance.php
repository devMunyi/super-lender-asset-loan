...
?>
        ...
        <div class="col-sm-12">
            <table id="example2" class="table table-condensed table-striped table-bordered">
                <thead>
                <tr><th>ID</th><th>Name</th><th>Branch</th><th>New Leads</th> <th>New Customers</th><th>New Total Loans</th> <th>Repeat Customers</th><th>Repeat Total Loans</th><th>All Total Loans</th><th>Total Repayable</th><th>Paid</th><th>Balance</th><th>Rate</th></tr>
                </thead>
                  <tbody>
                  <?php
                  ...
                  $kpi_measured_group = table_to_array("o_user_groups", "kpi_measured = 1", "100000", "uid");

        

                  $kpi_measured_group_list = implode(',', $kpi_measured_group);

                  // echo "kpi_measured_group_list: $kpi_measured_group_list";

                  $total_leads = $total_new_customers = $total_repeat_loans = $new_sum = $repeat_sum = $total_loans = $total_total_loans = $lo_rate = 0;
                  $bdos = fetchtable('o_users',"(user_group IN ($kpi_measured_group_list) OR uid = 6) AND status=1","uid","asc","1000","uid, name, branch");
