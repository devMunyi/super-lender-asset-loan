...
echo "<thead><tr><th>UID</th><th>Name</th><th>Phone</th><th>Branch</th><th>Principal</th><th>Interest</th><th>Membership</th><th>Total Repayable</th><th>Given Date</th><th>Days Passed</th><th>Daily Expected</th><th>Paid</th><th class='font-bold text-purple'>Deficit</th><th>Agent</th></tr></thead>";
?>
<tbody>
<?php
...
while($l = mysqli_fetch_array($loans)){
    ...
    echo "<tr><td>$uid</td><td>$name</td><td>$account_number</td><td>$branch_name</td><td>".money($loan_amount)."</td><td>".money($interest)."</td><td>".money($membership_fees)."</td><td>".money($interest_principal)."</td><td>$given_date</td><td>$days_ago</td><td>".money($daily_expected)."</td><td>".money($principle_interest_paid)."</td><td class='font-bold text-purple'>".money($deficit)."</td><td>$lo_co</td></tr>";
...
<?php
echo "<tfoot><tr><th>--</th><th>--</th><th>--</th><th>--</th><th>".money($loan_amount_total)."</th><th>".money($interest_total)."</th><th>".money($membership_total)."</th><th>".money($interest_principal_total)."</th><th>--</th><th>--</th><th>".money($daily_expected_total)."</th><th>".money($paid_total)."</th><th>".money($deficit_total)."</th><th>--</th></tr></tfoot>";
?>
</table>
