...
echo "<thead><tr><th>Year</th><th>Month</th><th>Principal</th><th>Interest</th><th>Total Repayable</th><th>Balances</th><th>Money Made</th><th>Default</th><th>Collection Rates</th></tr></thead>";
?>
<tbody>
<?php
...
while ($date1 <= $date2) {
    ...
    $money_made = false_zero($repaid_amount - $amt);

    $money_made_t+=$money_made;
    ...
    $interest_rate = round( ($repaid_amount/$total_rep)*100, 2);

    echo "<tr><td>$y_</td><td>$m_</td><td>".number_format($amt)."</td><td>".number_format($int_amount)."</td><td>".number_format($total_rep)."</td><td>".number_format($bal)."</td><td>".number_format($money_made)."</td><td>".number_format($defaulted)."</td><td>$crate%</td></tr>";
...
echo "<tfoot><tr><th colspan='2'>Total</th><th>".number_format($amt_t)."</th><th>".number_format($int_amount_t)."</th><th>".number_format($total_rep_t)."</th><th>".number_format($bal_t)."</th><th>".number_format($money_made_t)."</th><th>".number_format($defaulted_t)."</th><th>$crate_a%</th></tr></tfoot>";
