...
while($ad = mysqli_fetch_array($ado)){
    ...
    ///-----------------Initiation fees
    if($addon_id == 2){
        $membership_array = obj_add($membership_array, $loan_id, $addon_amount);
    }
    /////------------Interests
    if($addon_id == 5){
    ...
    /////------------Penalties
    if ($addon_id ==  12 || $addon_id == 3 || $addon_id == 7 || $addon_id == 11){
        $penalties_array = obj_add($penalties_array, $loan_id, $addon_amount);
    }
    if ($addon_id == 9){
     //   echo "jd";
        $late_fees_array = obj_add($late_fees_array, $loan_id, $addon_amount);
    }
}
...
while($l = mysqli_fetch_array($loans)){
    ...
    $late_fees = $late_fees_array[$uid];
    $membership = $membership_array[$uid];
