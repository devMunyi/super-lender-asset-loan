...
echo "<thead><tr><th>BID</th><th>Agent</th><th>Branch</th><th>Principal</th><th>Interest</th><th>Other Charges</th><th>Total(P+I)</th><th>Arrears Expected</th><th class='font-bold text-purple'>Arrears Paid</th><th>Arrears Balance</th><th>Arrears C.Rate</th><th>BM</th></tr></thead>";
echo "<tbody>";
...
foreach ($available_users_array as $bid => $bname) {
        ...
        echo "<tr><td>$bid</td><td class='font-italic'>$bname</td><td>$branchname</td><td>".number_format($bprinncipal)."</td><td>".number_format($binterest)."</td><td>".number_format($bother_charges)."</td><td>".number_format($btotal_PI)."</td><td class='text-bold'>".number_format($barrears_expected)."</td><td class='font-bold text-purple'>".number_format($barrears_paid)."</td><td class='text-red text-bold'>".number_format($barrears_balance)."</td><td class='text-bold text-blue'>$crate%</td><td>$bm</td></tr>";
...
echo "</tbody>";
echo "<tfoot><tr><th>--</th><th>--</th><th>Total</th><th>".number_format($bprinncipal_)."</th><th>".number_format($binterest_)."</th><th>".number_format($bother_charges_)."</th><th>".number_format($btotal_PI_)."</th><th>".number_format($barrears_expected_)."</th><th class='font-bold text-purple'>".number_format($barrears_paid_)."</th><th>".number_format($barrears_balance_)."</th><th>$crate_%</th><th>--</th></tr>";
