...
$branch_leads = array();
$leads = fetchtable('o_customers',"status = 3 $andbranch_client AND added_date BETWEEN '$start_date 00:00:00' AND '$end_date 23:59:59'","uid","asc","1000000","branch");
...
$interactions = fetchtable('o_customer_conversations', "conversation_date BETWEEN '$start_date 00:00:00' AND '$end_date 23:59:59' $andbranch_client", "uid", "asc", "1000000", "branch");
...
$due_ = fetchtable('o_loans', "disbursed=1 $andRegbranches_loan AND given_date BETWEEN '$thisyearmonth_last_month' AND '$thisyearmonthend'", "uid", "asc", "1000000", "total_repayable_amount, total_repaid, current_branch, loan_balance");
...
$customer_l = table_to_array('o_loans',"given_date BETWEEN '$start_date' AND '$end_date' AND disbursed=1 AND status!=0 $andbranch_loan","1000000","customer_id");
...
///------------Loans taken during
$loans_during = fetchtable('o_loans',"given_date BETWEEN '$start_date' AND '$end_date'  $andbranch_loan AND disbursed=1 AND status!=0 AND customer_id in ($customer_list)","uid","asc","1000000","customer_id");
...
$loans = fetchtable('o_loans',"given_date BETWEEN '$start_date' AND '$end_date' $andbranch_loan AND disbursed=1 AND status!=0","uid","asc","1000000","current_branch, customer_id, loan_amount");
...
?>
    ...
    <div class="col-sm-12">
        <table id="example2" class="table table-condensed table-striped table-bordered">
            <thead>
            <tr><th>ID</th><th>Branch</th><th>New Leads</th> <th>New Customers</th><th>New Total Loans</th> <th>Repeat Customers</th><th>Repeat Total Loans</th><th>Active Customers</th><th>All Total Loans</th><th>Total Interactions</th>
            <th>Collection Rate (%)</th></tr>
            </thead>
            <tbody>
            <?php
