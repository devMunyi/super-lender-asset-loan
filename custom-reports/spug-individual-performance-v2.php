    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <table id="example2" class="table table-condensed table-striped table-bordered">
                ...
                <tbody>
                <?php
                $total_repayable_total = $total_disbursed_total = $total_repaid_total = $total_balance_total = $total_loans_total = 0;
                for($i = 0; $i <= sizeof($lo); ++$i){
                    ...
                    $agent_name = trim($agent_names[$agent_id]);
                    $pair_name = trim($agent_names[$pair_id]);
