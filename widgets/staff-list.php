                        ...
                        <div class="col-md-10">
                            <h3 class="box-title font-16">
                                ...
                                <select class="btn font-16 btn-md btn-default text-bold top-select" id="sel_branch" onchange="staff_filters()">
                                    ...
                                    <?php
                                    $o_branches_ = fetchtable('o_branches', "status > 0", "name", "asc", "0,1000", "uid ,name ");
                                ...
                                <select class="btn font-16 btn-md btn-default text-bold top-select" id="sel_status" onchange="staff_filters()">
                                    <option value="0">All Statuses</option>
                                    <?php
                                    $o_status_ = fetchtable('o_staff_statuses', "uid > 0", "name", "asc", "0,50", "uid ,name");
                                    while ($s = mysqli_fetch_array($o_status_)) {
                                        $uid = $s['uid'];
                                        $name = $s['name'];
                                        echo "<option value='$uid'>$name</option>";
                                    }
