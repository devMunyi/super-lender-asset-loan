                        ...
                        <div class="col-md-10">
                            <h3 class="box-title font-16">
                                ...
                                <select class="btn font-16 btn-md btn-default text-bold top-select" id="sel_status" onchange="customer_filters()">
                                    ...
                                    <?php
                                    $o_statuses_ = fetchtable('o_customer_statuses', "status > 0 AND code = 3", "name", "asc", "0,10", "uid, code ,name");
...
<?php
echo "<div style='display: none;'>" . paging_values_hidden('uid > 0 AND status != 1', 0, 10, 'uid', 'desc', '', 'customer_list', 1) . "</div>"
?>