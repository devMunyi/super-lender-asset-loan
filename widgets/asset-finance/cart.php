                    ...
                    <div class="box box-default box-solid">
                        <div class="box-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tfoot>
                                    <tr class="bg-gray-light font-18">
                                        ...
                                        <th>__</th>
                                        <th>..</th>
                                        <th>Total: <span class="font-bold"
                                                id="cart_total"><?php echo money($cart_total); ?></span></th>
                                    </tr>
                                </tfoot>
                            </table>
                            <hr />
                            ...
                            <button class="btn btn-primary"
                                onclick="modal_view('/forms/asset_loan.php','asset_id=<?php echo $asset_id; ?>','New Asset Loan');">
                                Checkout</button>
                        </div>
                    </div>
                </div>
