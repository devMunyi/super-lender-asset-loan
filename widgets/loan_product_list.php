            ...
            <div class="box">
                ...
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                        <?php
                        $o_loan_products_ = fetchtable('o_loan_products',"status=1", "uid", "asc", "0,100", "uid ,name ,description ,period ,period_units ,min_amount ,max_amount ,pay_frequency ,percent_breakdown ,added_date ,status ");
                        while($u = mysqli_fetch_array($o_loan_products_))
                        {
                            ...
                            if(input_available($percent_breakdown) == 0){
                                $percent_breakdown = "Equal Installments";
                            }
                            ...
                            <td><span>$pay_frequency (Days)</span></td>
