...
$row_query = sanitizeAndEscape($_POST['row_query'], $con);
$branch_query = sanitizeAndEscape($_POST['branch_query'], $con);
$added_by = $userd['uid'];
$added_date = $fulldate;
...
$fds = array('title','description','row_query','branch_query','added_by','added_date','viewable_by','status');
$vals = array("$title","$description","$row_query","$branch_query","$added_by","$added_date","$viewable_by","$status");
