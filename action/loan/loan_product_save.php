...
$fds = array('name','description','period','period_units','min_amount','max_amount','pay_frequency','percent_breakdown','disburse_method','automatic_disburse','added_date','status');
$vals = array("$name","$description","$period","$period_units","$min_amount","$max_amount","$pay_frequency","$percent_breakdown","2","1","$added_date","$status");
...
{
    echo errormes('Unable to Create Record');
}
