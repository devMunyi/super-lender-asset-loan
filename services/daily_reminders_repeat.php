...
///////-------------------------End of get company details
        ///-------Lets start here
       $loans = fetchtable('o_loans',"disbursed=1 AND paid=0 AND status !=0","uid","asc","100000","uid, customer_id, account_number, product_id, loan_amount, disbursed_amount, total_repayable_amount, total_repaid, loan_balance, period, period_units, given_date, next_due_date, final_due_date, status");
