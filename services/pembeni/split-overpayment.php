...
$all_loans_with_overpayment = fetchtable("o_loans", "loan_balance <= -10 AND paid = 1 AND disbursed = 1 AND given_date >= '2025-03-01'", "uid", "ASC", "$limit", "uid, loan_balance"); // limit to 100 records to avoid timeout and be able to run the script multiple times with less blocking if they are many records
