...
$message = '';
if($sms_bal <= 100 && $sms_bal > 20) {
    $message = 'Greetings Admin. Superlender SMS Balance is Running Low.';
}else if ($sms_bal <= 20) {
    $message = 'Greetings, Admin! Superlender SMS balance is low, and customer reminders cannot be sent.';
}else {
    // $message = 'Greetings Admin. SMS balance is sufficient';
    // echo "SMS balance is sufficient.";
}
