...
if ($loan_id == 0) {
    echo "<tr><td colspan='3'> <i>Loan id was not parsed</i></td></tr>";
    exit();
} else {
...
if ($view_events == 1) {
    ...
    $o_events_ = fetchtable('o_events', "tbl='o_loans' AND fld=$loan_id AND status = 1", "uid", "ASC", "100", "uid, event_details, event_date ");
