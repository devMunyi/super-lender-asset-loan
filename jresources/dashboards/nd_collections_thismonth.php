...
while($l = mysqli_fetch_array($loans)){
    ...
    if((isDateInRange($final_due_date, $this_month_start, $date))){
    ...
    elseif ((isDateInRange($final_due_date, $last_month_start, $last_month)) || ($loan_status == 7)){
        ///----Overdue yesterday
...
<table class="table font-16 table-hover table-bordered">
    ...
    <tr class="text-red font-bold"><td>Overdue</td><td colspan="3"> <?php echo number_format($overdue_repayable_today); ?> <span class="label bg-danger
                            text-black"><?php echo $overdue_repayable_today_number;  ?> Loans</span> <i class="font-400">(Due Last Month)</i></td></tr>
