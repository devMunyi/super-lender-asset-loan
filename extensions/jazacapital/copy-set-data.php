...
$select_ = fetchtable('customers',"id > 0","id","asc","$offset,1000","id, title, firstname, lastname, middlename, marital_status, mm, dd, yyy, gender, postal_address, town, email_address, phone_number, id_number, residential, county, referee_name, referee_phone, logged_id, logged_user, officer_id, loan_balance, overpay, branch, business_name, business_type, daily_sales, landmark, year_est, business_reg_status, business_location, nok_name, nok_relationship, nok_phone, gmarital_status, road, gtitle, gfirstname, gphone_number, gmiddlename, gid_number, glastname, gmm, gdd, gyyyy, grelationship, goccupation, date, time, month, year, loan_app, prev_loan, inst_no, arrears_no, lastupdate, processing_fee, customer_passport, customer_id_front, customer_id_back, guarantor2_id_front, guarantor2_id_back, guarantor2_passport, business_photo, MPESA_statement, customer_sign, guarantor_sign, customer_status, registered_by, item1_customer, item1_description_customer, item1_serial_customer, item1_value_customer, item2_customer, item2_description_customer, item2_serial_customer, item2_value_customer, item3_customer, item3_description_customer, item3_serial_customer, item3_value_customer, item4_customer, item4_description_customer, item4_serial_customer, item4_value_customer, item5_customer, item5_description_customer, item5_serial_customer, item5_value_customer, item6_customer, item6_description_customer, item6_serial_customer, item6_value_customer, item1_guarantor, item1_description_guarantor, item1_serial_guarantor, item1_value_guarantor, item2_guarantor, item2_description_guarantor, item2_serial_guarantor, item2_value_guarantor, item3_guarantor, item3_description_guarantor, item3_serial_guarantor, item3_value_guarantor, item4_guarantor, item4_description_guarantor, item4_serial_guarantor, item4_value_guarantor, item5_guarantor, item5_description_guarantor, item5_serial_guarantor, item5_value_guarantor, item6_guarantor, item6_description_guarantor, item6_serial_guarantor, item6_value_guarantor, alternative_phone_number, house_name, house_number, defaulted_date, reg_status, updated, write_off, last_edit_by, last_edit_date, last_edit_time, loan_id, installs, pin_location, pin_location2, updt, loan_formpg1, loan_formpg2, loan_formpg3, hashed_phone, hashed_phone2, upd, logbook, repossession_form, approved_by");
