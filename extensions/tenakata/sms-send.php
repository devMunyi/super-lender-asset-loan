...
b843b5f49c4dd43b2d49ad2e0e476c1f1";
    ...
    curl_setopt_array($curl, array(
        CURLOPT_PORT => "8095",
        CURLOPT_URL => "https://eclecticsgateway.ekenya.co.ke:8095/smsengine/v1/single",
...
$res = sendSMS(254716330450, "Test tenakata");

$json = json_decode($res, true);
$balance = $json['ResultDetails']['CREDIT_BALANCE'];
