...
$disb = fetchtable('o_loans', "disbursed=1 AND status!=0 AND YEAR(given_date)='$year' AND MONTH(given_date)='$month' $andother $andbranch_loans", "uid", "asc", "1000000", "uid, loan_amount, customer_id, total_repayable_amount, total_repaid, current_branch , status");
...
// $total_principle =  totaltable('o_loans',"disbursed=1 AND status!=0 AND YEAR(given_date)='$year' AND MONTH(given_date)='$month' $andother $andbranch_loans","loan_amount");
...
while ($a = mysqli_fetch_array($addons)) {
    ...
    // processing fees
    if ($aid == 2) {
        $total_processing_fees = $total_processing_fees + $addon_amount;
    }
    ...
    // penalties
    if (in_array($aid, [4, 6, 7])) {
        $total_penalties += $addon_amount;
...
$total_expected = $total_disbursements * 1.24;
    ...
    <div class="row">
        <div class="col-sm-3">
            <table class="table table-bordered">
                <tr>
                    <td>Disbursements</td>
                    <td class="font-16 text-bold"><?php echo money($total_disbursements); ?></td>
                </tr>
                <tr>
                    <td>Expected</td>
                    <td class="font-16 text-bold"><?php echo money($total_expected); ?></td>
                </tr>
                <tr>
                    <td>Amount Repaid</td>
                    <td class="font-16 text-bold"><?php echo money($repaid_principle_interest_total); ?></td>
                </tr>
                <tr>
                    <td>Percentage</td>
                    <td class="font-24 text-bold"><?php echo false_zero($percentage_repaid); ?>%</td>
                </tr>
            </table>
        </div>
        <div class="col-sm-3">
            <table class="table table-bordered">
                <tr>
                    <td>New Member Loans:</td>
                    <td class="font-16 text-bold"><?php echo $new_customers; ?></td>
                </tr>
                <tr>
                    <td>Total Loans Issued:</td>
                    <td class="font-16 text-bold"><?php echo number_format(sizeof($all_loans)); ?></td>
                </tr>
                <tr>
                    <td>Average Loan Amount:</td>
                    <td class="font-16 text-bold"><?php echo money($average_loan_); ?></td>
                </tr>
                <tr>
                    <td>Loans Fully Repaid:</td>
                    <td class="font-16 text-bold"><?php echo number_format($fully_paid); ?></td>
                </tr>
            </table>
        ...
        <div class="col-sm-3">
            <table class="table table-bordered">
                <tr>
                    <td>Joining Fees:</td>
                    <td class="font-16 text-bold"><?php echo money(($total_joining_fees)); ?></td>
                </tr>
                <tr>
                    <td>Processing Fees:</td>
                    <td class="font-16 text-bold"><?php echo money($total_processing_fees); ?></td>
                </tr>
                <tr>
                    <td>Interest:</td>
                    <td class="font-16 text-bold"><?php echo money($total_interest); ?></td>
                </tr>
            </table>
        </div>
        <div class="col-sm-3">
            <table class="table table-bordered">
                <tr>
                    <td>Penalties:</td>
                    <td class="font-16 text-bold"><?php echo money($total_penalties); ?></td>
                </tr>
                <!-- <tr><td>Late Interest:</td><td class="font-16 text-bold"><?php // echo money($total_late_interest); 
                                                                                ?></td></tr> -->
                <!-- <tr><td>Principal:</td><td class="font-16 text-bold"><?php // echo money($total_principle); 
                                                                            ?></td></tr> -->
    ...
    <div class="well well-lg d-flex justify-content-center bd-highlight mb-3" style="text-align: center;">
        ...
        <table class="table  bd-highlight font-18 " style="width: 40%; text-align: center;">
            <tr>
                ...
                <td class="text-bold"><?php echo money($repaid_principle_interest_total); ?></td>
            </tr>
            <tr>
                <td>Total Disbursed:</td>
                <td class="text-bold"><?php echo money($total_disbursements); ?></td>
            </tr>
            <tr class="font-24 well-sm bg-orange">
                <td>Gross Revenue:</td>
                <td class="text-bold"><?php echo money($total_disbursements); ?></td>
            </tr>
            <tr>
                <td>Registration Fees:</td>
                <td class="text-bold"><?php echo money(($total_joining_fees)); ?></td>
            </tr>
            <tr>
                <td>Admin Fees:</td>
                <td class="text-bold"><?php echo money(($total_processing_fees)); ?></td>
            </tr>
            <tr class="font-24 well-sm bg-blue-gradient">
                <td>Total Gross Revenue:</td>
                <td class="text-bold"><?php echo money($repaid_principle_interest_total - $total_disbursements); ?></td>
            </tr>
        </table>
