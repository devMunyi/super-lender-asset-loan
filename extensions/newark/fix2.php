...
$sql = "SELECT uid, current_branch,  account_number, customer_id, loan_code FROM o_loans order by uid asc LIMIT 0, 40";
...
if ($result) {
    while ($row = mysqli_fetch_assoc($result)) {
         ...
         //  echo "$cid , $branch <br/>";
        $insertq="UPDATE o_incoming_payments SET customer_id='$customer_id', loan_id='$cid', mobile_number='$account', branch_id='$branch' WHERE loan_code='$loan_code' AND uid > 0 AND loan_id=0"; //var_dump($insertq);
        echo "$insertq;<br/>";
