...
if($session_d['uid'] < 1){
    ...
    ////////-------Check referred by
    $ref = 0;
    if((input_available($referrer_phone)) == 1 && $total_loans < 1){
   ...
   // die(json_encode($vals));
    ...
    if ($create == 1) {
        ...
        if($automatic_disburse == 1) {
           // send_money($primary_mobile, $amount, $latest_loan['uid']);
            ...
            if($total_loans >= 1 && $recent_loan == 0 && $amount < 50000 ){
                ...
                store_event('o_loans', $res, "Not sent automatically because (total loans: $total_loans and recent loan: $recent_loan)");
            }
        ...
        if($ref == 1){
            ...
            $save_promo = addtodb('o_promo_codes',$fds, $vals);
        }
