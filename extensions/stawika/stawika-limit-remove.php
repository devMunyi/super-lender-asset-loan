...
$loans = fetchtable('o_loans',"disbursed=1 AND paid=0 AND status !=0 ","uid","desc","0,10000","uid, customer_id, given_date, final_due_date, loan_amount, loan_balance, account_number, status");
...
$customers = fetchtable('o_customers',"uid in ($customers_string) AND loan_limit > 0","uid","asc","1000000","uid, loan_limit, primary_mobile");
