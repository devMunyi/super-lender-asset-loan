...
try {
    ...
    $loans = fetchtable('o_loans', "customer_id = $customer_id  AND status IN (1, 2, 3, 4, 7, 8) AND disbursed = 1", "uid", "desc", "1000", "uid, loan_amount, total_repayable_amount, total_repaid, loan_balance, given_date, disbursed, next_due_date, final_due_date, paid, status");
    $payload = array();
    $loan_count = 0;
    ...
    sendApiResponse2($http_status_code, $loan_count, "$message", $payload);
