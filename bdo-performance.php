...
<head>
    ...
    <title><?php echo $company['name']; ?> | BDO Performance</title>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                <button onclick="bdo_performance();" class="btn btn-primary bg-blue-gradient"><i class="fa fa-refresh"></i> Generate</button>
                                            </div>
                            ...
                            <!-- /.box-header -->
                            <div class="box-body">
                                <div class="container p-3 my-3 bg-gray-light" id="bdo_">
                               loading...
                                </div>
                            </div>
                            <!-- /.box-body -->
